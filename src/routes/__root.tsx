...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FreightVeil — Confidential Logistics Settlement" },
      {
        name: "description",
        content:
          "Confidential multi-carrier freight settlement on Midnight. Pay every carrier fairly. Reveal nothing.",
      },
      { name: "author", content: "FreightVeil" },
      { property: "og:title", content: "FreightVeil — Confidential Logistics Settlement" },
      {
        property: "og:description",
        content: "Shippers lock funds; carriers get their contracted rate; rates stay private.",
      },
